class ReportPdf < Prawn::Document
  ...
  # comments are from the guide Pat M was following from https://www.sitepoint.com/pdf-generation-rails/
  ...
  def table_content
    # This makes a call to donor_rows and gets back an array of data that will populate the columns and rows of a table
